...
class JSONRPCPlaygroundApp:
    ...
    def _setup_page_config(self):
        ...
        /* Simple developer credit styling with GitHub link */
        .simple-credit {
            text-align: center;
            font-size: 0.85rem;
            color: #777;
    ...
    def _render_header(self):
        ...
        st.markdown(
            '''<div class="simple-credit">
                Developed by M Rehan ul Haq
                <a href="https://github.com/Rehan-Ul-Haq/jsonrpc-playground" target="_blank" class="github-link">
